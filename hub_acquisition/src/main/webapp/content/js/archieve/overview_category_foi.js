...
//	d3.select(".layer1_svg").append("defs").selectAll("marker")
...
// 	        	return d.value/d.count;
    ...
    var link_label = graph_g.selectAll(".link_label")
					    .data(links)
					    .enter()
					    .append("text")
	...
	node = graph_g.append("g")
					 ...
					 .on('click', function(d) {
					      if (toggle == 0) {
						      ...
						      d3.selectAll('.link_label')
					      		.style('opacity', function (l) {

					      			return l.target == d || l.source == d ? 0.75 : 0.01;
...
//         return [
//             "M",x1,y1,
//             "A",drx,dry,xRotation,largeArc,sweep,mx,my,
//             "A",drx,dry,xRotation,largeArc,sweep,x1,y1,
//
//           ].join(" ");
