...
<title>Search Cooling Chamber</title>
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item active">
				...
				<div id="collapse_nav_cooling_chamber" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Select action</h6>
						<a class="collapse-item" href="user/search/cooling_chamber">Search & Add</a> 
						<a class="collapse-item active" href="user/search_for_view/cooling_chamber">Search & View</a> 						
					</div>
				</div>
			</li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">Search Cooling Chamber </h1>
								...
								<div class="card-body ">
									...
									<div class="row mb-5 border-bottom ">
										<div class="col ">
											...
											<p class="h6 text-black-50 search_table_header"> Latest 100 Cooling Chamber  </p>
...
<!-- 	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous"></script> -->
	...
	<script src="content/js/search_for_view_cooling_chamber.js"></script>
	...
	<script type="text/javascript">
		...
		init_search_for_view_cooling_chamber();
