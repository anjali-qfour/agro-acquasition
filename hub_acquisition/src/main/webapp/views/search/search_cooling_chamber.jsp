...
<title>Search Consignments</title>
...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">Search Consignments </h1>
									...
									<form >
										...
										<div class="row ">
											<div class="col " data-toggle="popover" data-placement="top" data-container="body">
												...
												<div class="search-id-group form-group input-group input-group-joined mt-3 mb-0" >
										...
										<div class="row   ">
											...
											<div class="col-2  pt-4 ">
												...
												<div class="form-check form-switch ml-4">
													<input id="id_switchcheck" class="form-check-input " type="checkbox" checked>
											...
											<div class="col-2 pt-4 ">
												...
												<div class="form-check form-switch  float-right mr-3">
													...
													<label class="form-chec	k-label" for="date_switchcheck">By Date</label>
												</div>
								...
								<div class="card-body ">
									...
									<div class="row mb-5 border-bottom ">
										<div class="col ">
											...
											<p class="h6 text-black-50 search_table_header"> Latest 100 Consignment  </p>
						...
						<div class="card shadow mb-4">
							<div class="card-body">
								...
								<div class="d-flex justify-content-end " >
									...
									<div class="pr-3  align-self-center text-end group_btn_message " >
									 
									</div>
									
									<button class="btn btn-success btn-icon-split float-right ask_group_btn" type="button" data-toggle="modal" data-target="#ask_group">
	...
	<div class="modal fade" id="ask_group" tabindex="-1" aria-labelledby="ask_group_label" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="ask_group_label">Grouping Consignments</h5>
	        <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
	      </div>
	      <div class="modal-body ask_group_message">

	      </div>
	      <div class="modal-footer">
	        
	        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
			<button class="btn btn-success btn-icon-split float-right group_btn" type="button" data-toggle="modal" data-target="#ask_group">
...
<!-- 	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous"></script> -->
	...
	<script src="content/js/search_cooling_chamber.js"></script>
