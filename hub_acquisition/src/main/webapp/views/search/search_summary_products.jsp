...
<title>Search products summary</title>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">Search  Products Summary</h1>
								...
								<div class="card-body">
									...
									<div class="row pb-4 mb-5 border-bottom">
										...
										<div class="col">
											...
											<button class="btn btn-success btn-icon-split float-right see_today_btn" type="submit">
											
												<span class="icon text-white-50" >
													<i class="fas fa-calendar-day"></i>
												</span>
												<span class="text"> See Today </span>
...
<!-- 	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-year-calendar/1.1.1/css/bootstrap-year-calendar.css" integrity="sha512-L8m7hhyJY8UuDj8Bn+hor5xRONOiIZvSCBHZtZg6IznH85v0j0ygpXQCbavAXa+BZmHSZgI92zHWCkQlaaIZUQ==" crossorigin="anonymous" /> -->
	...
	<script src="content/js/search_summary_products.js"></script>
