...
<title>Search Transporter (Farm to Hub) Invoice</title>
...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">Search Transporter (Farm to Hub) Invoice</h1>
									...
									<form >
										...
										<div class="row ">
											<div class="col " data-toggle="popover" data-placement="top" data-container="body">
												...
												<div class="search-id-group form-group input-group input-group-joined mt-1 mb-0" >
	...
	<div class="modal fade" id="ask_group" tabindex="-1" aria-labelledby="ask_group_label" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="ask_group_label">Grouping Invoices</h5>
...
<!-- 	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous"></script> -->
	...
	<script src="content/js/search_transporter_f2h_invoice.js"></script>
	...
	<script type="text/javascript">
		...
		init_search_transporter_f2h_invoice();
