		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">View & Edit Farmer </h1>
									...
									<div class="payment_detail ">
										...
										<div class="row ">
											<div class="col-4">
												...
												<div class="form-group mb-4">
													<label for="payment_bank_name_input"> Bank name </label> 
													<input  id="payment_bank_name_input" class="form-control " type="text" placeholder="">
												</div>
											...
											<div class="col-4">
												...
												<div class="form-group mb-4">
													<label for="payment_bank_branch_name_input"> Branch name</label> 
													<input  id="payment_bank_branch_name_input" class="form-control " type="text" placeholder="">
												</div>
											...
											<div class="col-4">
												...
												<div class="form-group mb-4">
													...
													<input id="ifsc_code_input" class="form-control "  type="text" placeholder="">
												</div>
										...
										<div class="row ">
											...
											<div class="col-4">
												...
												<div class="form-group mb-4">
													...
													<input id= "account_name_input" class="form-control "  type="text" placeholder="">
												</div>
											...
											<div class="col-4">
												...
												<div class="form-group mb-4">
													...
													<input  id="account_number_input" class="form-control " type="text" placeholder="">
												</div>
											...
											<div class="col-4">
												...
												<div class="form-group mb-4">
													<label for="gst_number_input">GST number </label> 
													<input id="gst_number_input" class="form-control "  type="text" placeholder="">
												</div>
...
<!-- 	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous"></script> -->
	...
	<script src="content/js/view_farmer.js"></script>
	...
	<script type="text/javascript">
		...
		var farmer_id = getUrlParameter("i").toLowerCase();
		var primary_id = farmer_id;
