...
<title>Search Consignment</title>
			...
			<li class="nav-item  active">
				...
				<div id="collapse_nav_consignment" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item  active" href="user/search/consignment">Search & view</a>						
					</div>
				</div>
			</li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">Search Consignment </h1>
									...
									<form >
										...
										<div class="row ">
											<div class="col " data-toggle="popover" data-placement="top" data-container="body">
												...
												<div class="search-id-group form-group input-group input-group-joined mt-2 mb-0" >
											
													<input id="search_input" class="form-control  border-blue border-right-0 border " type="text" data-toggle="popover"  placeholder="Search all" 														   
														   >
													<!-- 														   data-bs-toggle="popover" data-bs-placement="top"  title="Popover title" data-bs-content="And here's some amazing content. It's very engaging. Right?" -->
										...
										<div class="row ml-3 d-flex align-items-center">
											...
											<div class="col-2 mr-3 ">
												...
												<div class="form-check form-switch d-flex">
													<input id="id_switchcheck" class="form-check-input" type="checkbox" checked disabled>
											...
											<div class="col-3 mr-5">
												<div class="form-floating ">
												  	<input id="start_date" class="form-control   border-top-0 border-left-0 border-right-0  rounded-0" type="text" name="start_date" placeholder="Start date">
											...
											<div class="col-3 mr-5">
												<div class="form-floating ">
												  	<input id="end_date" class="form-control   border-top-0 border-left-0 border-right-0  rounded-0" type="text" name="end_date"  placeholder="Start date">
...
<!-- 	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" /> -->
	...
	<script src="content/js/search_consignment.js"></script>
