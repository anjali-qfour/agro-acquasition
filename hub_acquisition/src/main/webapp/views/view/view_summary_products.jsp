...
<title>View summary products</title>
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item  active">
				...
				<div id="collapse_nav_adminuser" class="collapse show " aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Select action</h6>
						<a class="collapse-item active" href="user/search/summary/products">Products</a> 
					</div>
				</div>
			</li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">View Products Summary </h1>
								...
								<div class="card-body">
									<div class="row">
											<div class="col-6">
												...
												<div class="d-flex flex-row  fs-3 text">												
													<Span id = "date_month_label"class="pr-2 font-weight-bold text-dark "> </Span>
													<Span id = "year_label" class=" fw-light text-dark  ">  </Span>
												</div>		
											
												<Span id = "days_label" class=" text-secondary ">  </Span>
												
											
											</div>
											<div class="col-6 border-left pl-4 pt-3">
	
												
												<a href="/user/search/summary/products" class="btn btn-primary btn-icon-split float-right p-0 select_day_btn" type="button"  >
												
													<span class="icon text-white-50" >
														<i class="far fa-calendar-alt"></i>
													</span>
													<span class="text"> Select Day </span>
...
<!-- 	<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-year-calendar/1.1.1/js/bootstrap-year-calendar.min.js" integrity="sha512-YSELDRRABbljI98CrQE3B4clB1VlQLeqeaG9fwwqb9CrJu/OtM6T/RfQfYNud2wBjJVw55FMyQqKd/tcIxx2fQ==" crossorigin="anonymous"></script> -->
<!-- 	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-year-calendar/1.1.1/css/bootstrap-year-calendar.css" integrity="sha512-L8m7hhyJY8UuDj8Bn+hor5xRONOiIZvSCBHZtZg6IznH85v0j0ygpXQCbavAXa+BZmHSZgI92zHWCkQlaaIZUQ==" crossorigin="anonymous" /> -->


	<script src="content/js/lib/bootstrap-year-calendar.min.js"></script>
	<link rel="stylesheet" href="content/css/bootstrap-year-calendar.min.css"  />
	...
	<script src="content/js/view_summary_products.js"></script>
	...
	<script type="text/javascript">
		...
		var current_date = getUrlParameter("d");
		

		
		
		init_search_summary_products();
