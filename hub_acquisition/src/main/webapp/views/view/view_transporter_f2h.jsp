...
<title>View & Edit Transporter (Farm to Hub)</title>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">View & Edit Transporter ( Farm to Hub ) </h1>
										...
										<div class="row ">
											...
											<div class="col-3">
												<div class="form-group mb-4">
													...
													<input id="comp_name_input" class="form-control "  type="text" placeholder="">
												</div>
											</div>
											...
											<div class="col-7">
												<div class="form-group">
													...
													<textarea id="comp_address_input" class="form-control"  rows="3"></textarea>
												</div>
											</div>
											...
											<div class="col-2">
												<div class="form-group mb-4">
													...
													<input  id="comp_pincode_input" class="form-control " id="comp_pincode_input" type="text" placeholder="">
												</div>
											</div>
...
<!-- 														     <span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span>  -->
	...
	<script src="content/js/view_transporter_f2h.js"></script>
	...
	<script type="text/javascript">
		...
		var transporter_f2h_id = getUrlParameter("i").toLowerCase();


		
		init_view_transporter_f2h();
