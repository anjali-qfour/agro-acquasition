...
<title>View Farmer Invoice</title>
...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">View Farmer Invoice </h1>
					...
					<div class="row">
						<div class="col">
							...
							<div class="card shadow mb-4">
								<div class="card-header">Farmer Invoice</div>
								<div class="card-body">
									...
									<form>
										...
										<div class="form-group mb-5">
											<label for="farmer_invoice_id_input" class="text-blue " >Farmer Invoice ID </label> 
											<input id="farmer_invoice_id_input" class="form-control  border-0 text-uppercase text-monospace"  type="text" placeholder="" value="" readonly>
										</div>
										...
										<div class="row ">
											<div class="col-4">
												...
												<div class="form-group">
													<label for="farmer_full_name_input" class="text-blue " >Full Name</label> 
													<input  id="farmer_full_name_input" class="form-control border-0 text-capitalize" type="text" placeholder="" readonly>
												</div>
											...
											<div class=col-4>
												<div class="form-group mb-4">
													<label for="farmer_phone_input" class="text-blue " >Phone number  </label> 
													<input id="farmer_phone_input" class="form-control border-0 text-uppercase"  type="text" placeholder="" readonly>
												</div>
											</div>
										...
										<div class="invoice_details_row">
											...
											<div class="row d-flex flex-column h-75 printout_row" style="  background-color:white;">
											
											
												<div class="col border border-dark rounded  " >
												
													<div class="d-flex flex-column  invoice_details">
					...
					<div class="col">
						...
						<div class="card shadow mb-4">
							<div class="card-body d-flex justify-content-between">
								...
								<button class="btn btn-success btn-icon-split float-left print_invoice_btn" type="submit">
	...
	<script src="content/js/view_farmer_invoice.js"></script>
	...
	<script type="text/javascript">
		...
		var farmer_invoice_id = getUrlParameter("i");


		
		init_view_farmer_invoice();
