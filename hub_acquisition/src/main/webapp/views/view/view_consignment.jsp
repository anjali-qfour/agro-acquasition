...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div id= "timeline_row" class="row mb-1">
						<div class="col">
						
						
								<button class="btn btn-light btn-icon-split float-right refreash_btn" type="submit">
	...
	<script src="content/js/view_consignment.js"></script>
	...
	<script type="text/javascript">
		...
		var consignment_id = getUrlParameter("i");
		var primary_id = consignment_id;


		init_view_consignment();
