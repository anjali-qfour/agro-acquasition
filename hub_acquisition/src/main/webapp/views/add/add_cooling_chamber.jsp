...
<title>Add Cooling Chamber</title>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">Add Cooling Chamber </h1>
											...
											<div class="col-4">
												...
												<div class="form-group">
										        	...
										        	<select id="category_select" class="form-control  border-blue" >
											           ...
											           <option  data-id="cooling_chamber_a" >Cooling Chamber A</option>
											           <option  data-id="cooling_chamber_b" >Cooling Chamber B</option>
											        </select>
										    	</div>
										...
										<div class="row">
											<div class="col-4">
												...
												<div class="form-group">
													...
													<input id="temperature_input" class="form-control  border-blue"  type="number" placeholder="Enter Temperature">
												</div>
											...
											<div class="col-4">
												...
												<div class="form-group">
													...
													<input id="humidity_input" class="form-control border-blue"  type="number" placeholder="Enter Humidity" >
												</div>
											...
											<div class="col-4">
												...
												<div class="form-group">
													...
													<input id="time_input" class="form-control border-blue"  type="number" placeholder="Enter Time In Hour" >
												</div>
					...
					<div class="col">
						...
						<div class="card shadow mb-4">
							<div class="card-body">
								...
								<button class="btn btn-success btn-icon-split float-right save_cooling_chamber_btn" type="submit">
...
<!-- 	<script src="https://unpkg.com/jspdf@latest/dist/jspdf.umd.min.js"></script> -->
	...
	<script src="content/js/add_cooling_chamber.js"></script>
